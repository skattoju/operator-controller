...
func (in *ClusterExtensionInstallConfig) DeepCopyInto(out *ClusterExtensionInstallConfig) {
	*out = *in
	...
	if in.ConfigSources != nil {
		...
		*out = new(ConfigSourceReferences)
		(*in).DeepCopyInto(*out)
	}
	if in.Preflight != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigSourceReferences) DeepCopyInto(out *ConfigSourceReferences) {
	*out = *in
	...
	if in.TextConfigs != nil {
		in, out := &in.TextConfigs, &out.TextConfigs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigSourceReferences.
func (in *ConfigSourceReferences) DeepCopy() *ConfigSourceReferences {
	if in == nil {
		return nil
	}
	out := new(ConfigSourceReferences)
